<div class="jumbotron text-center">
  ...
  <form class="form-inline">
    <input type="email" class="form-control" size="50" placeholder="Cadastre seu email e faça parte da nossa família" required>
